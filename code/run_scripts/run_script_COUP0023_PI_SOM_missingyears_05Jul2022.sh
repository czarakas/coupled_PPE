...
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
export CESM_CASE_NAME=COUP0023_PI_SOM_v03
...
export FILENAME=/glade/u/home/czarakas/coupled_PPE/code/run_scripts/run_script_COUP0023_PI_SOM_missingyears_05Jul2022.sh
export RESTART_DIR=/glade/scratch/czarakas/archive/COUP0023_PI_SOM_v02/rest/0154-01-01-00000 #where the restart files to use are
...
./xmlchange RUN_REFCASE=COUP0023_PI_SOM_v02
...
# Modify namelists
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
cp "/glade/scratch/djk2120/PPEn11/namelist_mods/OAAT0146.txt" user_nl_clm
...
!----------------------------------------------------------------------------------
! ---------------------------------PARAMETER FILE----------------------------------
paramfile = "/glade/scratch/djk2120/PPEn11/paramfiles_old/OAAT0146.nc"
