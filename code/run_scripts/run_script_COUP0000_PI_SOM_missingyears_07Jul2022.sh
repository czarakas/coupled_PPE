...
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
export CESM_CASE_NAME=COUP0000_PI_SOM_v03
...
export FILENAME=/glade/u/home/czarakas/coupled_PPE/code/run_scripts/run_script_COUP0000_PI_SOM_missingyears_07Jul2022.sh
export RESTART_DIR=/glade/scratch/czarakas/archive/COUP0000_PI_SOM/rest/0134-01-01-00000 #where the restart files to use are
...
./xmlchange RUN_REFCASE=COUP0000_PI_SOM
...
!----------------------------------------------------------------------------------
! ---------------------------------PARAMETER FILE----------------------------------
paramfile = "/glade/scratch/djk2120/PPEn11/paramfiles_old/OAAT0000.nc"
