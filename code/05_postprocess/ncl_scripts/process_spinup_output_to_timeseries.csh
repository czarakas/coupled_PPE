...
set atm_vars_monthly = (FLNT FSNT TS TREFHT co2vmr PRECT ICEFRAC)
#set atm_vars_daily = ( TSMN TSMX PRECT TS )

set lnd_vars_monthly = (GPP) #TLAI PCO2 PBOT TLAI TSAI TBOT TSA TSKIN GPP NPP NEE ER AR HTOP TWS TOTVEGC TOTVEGN TOTECOSYSC TOTECOSYSN FSNO)
