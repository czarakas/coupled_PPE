...
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
export CESM_CASE_NAME=COUP0004_PI_SOM_v03
...
export FILENAME=/glade/u/home/czarakas/coupled_PPE/code/run_scripts/run_script_COUP0004_PI_SOM_missingyears_05Jul2022.sh
export RESTART_DIR=/glade/scratch/czarakas/archive/COUP0004_PI_SOM_v02/rest/0134-01-01-00000 #where the restart files to use are
...
./xmlchange RUN_REFCASE=COUP0004_PI_SOM_v02
...
# Modify namelists
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
cp "/glade/scratch/djk2120/PPEn11/namelist_mods/OAAT0024.txt" user_nl_clm
...
!----------------------------------------------------------------------------------
! ---------------------------------PARAMETER FILE----------------------------------
paramfile = "/glade/scratch/djk2120/PPEn11/paramfiles_old/OAAT0024.nc"
