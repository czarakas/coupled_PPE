...
export FILENAME=/glade/u/home/czarakas/coupled_PPE/code/run_scripts/run_script_COUP0037_PI_SOM_missingyears_pt2_20Oct2023.sh
export RESTART_DIR=/glade/scratch/czarakas/archive/CoupledPPE/COUP0037_PI_SOM_v02/rest/0150-01-01-00000 #where the restart files to use are
...
./xmlchange RUN_REFCASE=COUP0037_PI_SOM_v02
./xmlchange RUN_REFDATE=0150-01-01
...
./xmlchange JOB_WALLCLOCK_TIME=00:28:00 --subgroup case.run
...
# Modify namelists
# + ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
cp "/glade/u/home/czarakas/coupled_PPE/data/namelist_mods/OAAT0014.txt" user_nl_clm
...
!----------------------------------------------------------------------------------
! ---------------------------------PARAMETER FILE----------------------------------
! this paramfile is very similar to OAAT0014 - 0.000001 was added to each parameter value for rhosnir
! e.g. 0.588 -> 0.588001
paramfile = "/glade/u/home/czarakas/coupled_PPE/data/paramfiles/OAAT0014_mod2.nc"
