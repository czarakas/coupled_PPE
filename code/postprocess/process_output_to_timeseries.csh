...
set caselist =(COUP0000_PI_SOM) #OFFL0000_PI_CPLhist OFFL0000_PI_v02) 


# List the variables which you want to make time series of here (for now, I'm just doing a handfull).
set atm_vars_monthly = (FLNT FSNT TS TREFHT ICEFRAC)# co2vmr)
#set atm_vars_daily = ( TSMN TSMX PRECT TS )

set lnd_vars_monthly = (GPP TSA TBOT HBOT HTOP TOTVEGC TOTVEGN) # PCO2 PBOT TLAI TSAI TBOT TSA TSKIN GPP NPP NEE ER AR HTOP TWS TOTVEGC TOTVEGN TOTECOSYSC TOTECOSYSN FSNO)
...
set basedir = /glade/campaign/cgd/tss/czarakas
